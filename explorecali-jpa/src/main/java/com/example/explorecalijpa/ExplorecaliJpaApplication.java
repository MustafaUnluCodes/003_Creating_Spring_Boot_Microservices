	...
	public OpenAPI swaggerHeader() {
		return new OpenAPI()
				.info(new Info()
						...
						.version("3.0.0"))
				.addTagsItem(new Tag()
						.name("Tour Package") // Repository'deki @Tag name ile birebir aynı olmalı
						.description("The Tour Package API - Bu bölüm tur paketlerinin tüm CRUD işlemlerini yönetir."));
